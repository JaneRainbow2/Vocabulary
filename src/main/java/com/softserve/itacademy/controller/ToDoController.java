...
public class ToDoController {
    ...
    @GetMapping("/{id}/add")
    public String addCollaborator(@PathVariable long id, @RequestParam("userId") long userId) {
        ToDo todo = todoService.readById(id);
    ...
    public String removeCollaborator(@PathVariable long id, @RequestParam("userId") long userId) {
        ToDo todo = todoService.readById(id);
        List<User> collaborators = todo.getCollaborators();
